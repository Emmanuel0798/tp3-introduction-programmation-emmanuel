...
class Coordonnee :
    typeCoordinate : str
    def __post_init__(typeCoordinate, coordinateInput, self) -> list:  
    ...
    if typeCoordinate == "setBoats" :   # Si la fonction appelée doit renvoyer les coordonnées lors du choix des postions des bateaux
    ...
    if typeCoordinate == "setShoot" :   # Si la fonction appelée doit renvoyer les coordonnées lors du choix de tire
        any 
